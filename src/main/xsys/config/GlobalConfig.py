...
from src.main.xsys.utils.Logger import Logger
...
class GlobalConfig(object):
    ...
    def platform_identifier(self, commands='chrome'):
        self.logger.debug('GlobalConfig - Calling on "platform_identifier" -> {0}'.format(commands))
    ...
    def get_Driver(self, os, flag):
        self.logger.debug('GlobalConfig - Calling on "get_Driver" -> {0} : {1}'.format(os, flag))
    ...
    def get_ChromeDriver(self):
        self.logger.debug('GlobalConfig - Calling on "get_ChromeDriver"')
    ...
    def get_PhantomDriver(self):
        self.logger.debug('GlobalConfig - Calling on "get_PhantomDriver"')
        USER_HOME = expanduser("~")
        PROJ_PATH = '{0}\\Desktop\\Git\\Automation-Python-Shorten-Url'.format(USER_HOME)
        BIN_PATH = '{0}\\src\\bin'.format(PROJ_PATH)
    ...
    def get_ScreenshotDir(self):
        self.logger.debug('GlobalConfig - Calling on "get_ScreenshotDir"')
        USER_HOME = expanduser("~")
        PROJ_PATH = '{0}\\Desktop\\Git\\Automation-Python-Shorten-Url'.format(USER_HOME)
    ...
    def get_LogsDir(self):
        self.logger.debug('GlobalConfig - Calling on "get_LogsDir"')
        USER_HOME = expanduser("~")
        PROJ_PATH = '{0}\\Desktop\\Git\\Automation-Python-Shorten-Url'.format(USER_HOME)
    ...
    def get_GhostLogDir(self):
        self.logger.debug('GlobalConfig - Calling on "get_GhostLogDir"')
    ...
    def get_GridDir(self):
        self.logger.debug('GlobalConfig - Calling on "get_GridDir"')
    ...
    def get_ResultsDir(self):
        self.logger.debug('GlobalConfig - Calling on "get_ResultsDir"')
